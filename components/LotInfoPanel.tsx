...
export const LotInfoPanel: React.FC = () => {
    ...
    return (
        <div className={`fixed top-1/2 left-8 -translate-y-1/2 z-30 p-8 rounded-2xl max-w-sm w-full shadow-2xl border backdrop-blur-md transition-all duration-500 pointer-events-auto ${isNight ? 'bg-black/80 border-white/10 text-white' : 'bg-white/90 border-[#1e293b]/10 text-[#1e293b]'}`}>
